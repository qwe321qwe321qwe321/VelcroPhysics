    ...
    public class PrismaticJoint : Joint
    {
        ...
        public float JointTranslation
        {
            get
            {
                ...
                XNAVector2 axis = BodyA.GetWorldVector(LocalXAxis);
        ...
        public float JointSpeed
        {
            get
            {
                ...
                float speed = XNAVector2.Dot(d, MathUtils.Cross(w1, axis)) + XNAVector2.Dot(axis, v2 + MathUtils.Cross(w2, r2) - v1 - MathUtils.Cross(w1, r1));
                return speed;
            }
        }
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            ...
            XNAVector2 axis = MathUtils.Mul(qA, LocalXAxis);
            float a1 = MathUtils.Cross(d + rA, axis);
            float a2 = MathUtils.Cross(rB, axis);
            XNAVector2 perp = MathUtils.Mul(qA, _localYAxisA);
